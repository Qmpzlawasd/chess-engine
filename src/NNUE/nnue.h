 ...
 * Load NNUE file
 */
DLLExport void _CDECL nnue_init(const char *evalFile /** Path to NNUE file */
);
 ...
 */
DLLExport int _CDECL nnue_evaluate_fen(const char *fen /** FEN string to probe evaluation for */
);
 ...
 *   Score relative to side to move in approximate centi-pawns
 */
DLLExport int _CDECL nnue_evaluate(int player,  /** Side to move: white=0 black=1 */
 ...
 */
DLLExport int _CDECL nnue_evaluate_incremental(int player,          /** Side to move: white=0 black=1 */
                                               int *pieces,         /** Array of pieces */
                                               int *squares,        /** Corresponding array of squares each piece stands on */
